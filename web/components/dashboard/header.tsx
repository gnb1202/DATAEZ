...
const titles: Record<Section, string> = { dashboard: "대시보드", analysis: "AI 분석", history: "분석 이력", tables: "데이터 관리", settings: "설정" };
export function Header({ activeSection, selectedProject, chatOpen, showChatToggle, onToggleChat, onOpenMenu }: {
  activeSection: Section; selectedProject: Project | null; chatOpen: boolean; showChatToggle: boolean; onToggleChat: () => void; onOpenMenu: () => void;
}) {
